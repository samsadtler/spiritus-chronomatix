...
public class PoseController : MonoBehaviour , ITangoPose {
	...
	/*public void OnTangoImageAvailable(Tango.TangoEnums.TangoCameraId cameraId, Tango.TangoImageBuffer image){
		Debug.Log ("HERE IN IMAGE AVAILABLE");
	}

	public void OnExperimentalTangoImageAvailable(){
		Debug.Log ("HERE IN IMAGE AVAILABLE 2");
	}*/
